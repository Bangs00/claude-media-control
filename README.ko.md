...
| "statusline 배치 바꿔줘" | `/media:statusline` | 미리보기로 레이아웃을 고르거나, 항목 순서를 직접 구성 |
...
순서로, 한 줄로 붙일지 여러 줄로 나눌지까지 정할 수 있습니다. 프리셋이
마음에 안 들면 `Custom…`으로 표시할 항목과 맨 앞에 올 항목을 하나씩 고르면
됩니다. 항목은 저장한 순서 그대로 그려지기 때문에 "시간을 맨 앞에",
